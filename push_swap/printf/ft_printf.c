...
int	main(void)
{
	printf("ORIGINAL:   %d, %i, %c, %s, %p, %x, %X, %u, %%\n", 2147483647, 30,
	 'A', (char *)NULL, NULL, 305441741, 305441741, (unsigned int)4294967295);
	ft_printf("FT_PRINTF:  %d, %i, %c, %s, %p, %x, %X, %u, %%\n", 2147483647, 
	30, 'A', (char *)NULL, NULL, 305441741, 305441741, (unsigned int)4294967295);
	return (0);
}
*/